...
public class AccountFieldHandler {

    public boolean  checkAccountField(String id) throws Exception {


        //URL TO GET CUSTOM OBJECT DATA.
        String url = "https://secure.p06.eloqua.com/api/REST/1.0/assets/account/field/" + id;
        ...
        if(creationDate.equals(updatedDate)){
